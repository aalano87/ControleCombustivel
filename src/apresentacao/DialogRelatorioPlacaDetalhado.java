 ...
 * @author novo
 */
public class DialogRelatorioPlacaDetalhado extends javax.swing.JDialog {
     ...
     */
    public DialogRelatorioPlacaDetalhado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Relatório Detalhado Proprietário");
    ...
    private void btGeraRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGeraRelatorioActionPerformed
        try {
            ...
            Logger.getLogger(DialogRelatorioPlacaDetalhado.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void tfProprietarioKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfProprietarioKeyReleased
    }//GEN-LAST:event_tfProprietarioKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogRelatorioPlacaDetalhado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogRelatorioPlacaDetalhado dialog = new DialogRelatorioPlacaDetalhado(new javax.swing.JFrame(), true);
    ...
    public void data() throws SQLException, ExcecaoConexao, ExcecaoSQL {
        try {
            InputStream is = getClass().getResourceAsStream("/relatorios/relatorioDetalhadoPlaca.jasper");
            ...
            String proprietario = tfProprietario.getText().toUpperCase();
            ImageIcon gto = new ImageIcon(getClass().getResource("/icon/logo2.jpg"));            
            map.put("DataInicio", Cdata1);
            map.put("DataFim", Cdata2);
...
//    }
    ...
    public void keyPressed(KeyEvent e){  
        ...
        if (e.getKeyCode() == KeyEvent.VK_ENTER) {  
            ...
            btGeraRelatorioActionPerformed(null);
        }  
      }
