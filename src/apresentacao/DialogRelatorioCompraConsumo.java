 ...
 * @author novo
 */
public class DialogRelatorioCompraConsumo extends javax.swing.JDialog {
     ...
     */
    public DialogRelatorioCompraConsumo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Relatório Compra X Consumo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogRelatorioCompraConsumo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogRelatorioCompraConsumo dialog = new DialogRelatorioCompraConsumo(new javax.swing.JFrame(), true);
    ...
    public void data() throws SQLException, ExcecaoConexao, ExcecaoSQL {
        try {
            InputStream is = getClass().getResourceAsStream("/relatorios/ConsumoCompra.jasper");
           // JasperReport jr = (JasperReport) JRLoader.loadObject(getClass().getResource("/relatorios/ConsumoCompra.jasper"));
